...
<model modelUID="r:73355133-3b63-4ae4-8b45-1fe6e5a414f0(Diglex.structure)">
  ...
  <refactoringHistory>
    ...
    <refactoringContext modelVersion="18">
      ...
      <conceptFeatureMap>
        <entry>
          <key featureName="letter" conceptFQName="Diglex.structure.LexemSymbol" featureKind="PROPERTY" />
          <value featureName="symbol" conceptFQName="Diglex.structure.LexemSymbol" featureKind="PROPERTY" />
        </entry>
      </conceptFeatureMap>
    </refactoringContext>
  </refactoringHistory>
