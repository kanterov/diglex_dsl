...
<language namespace="diglex.dsl" uuid="bdafc912-c4d6-4e59-a78e-488eda416d0f" generatorOutputPath="${language_descriptor}/runtime" java-stubs-enabled="false" compileInMPS="true" doNotGenerateAdapters="false">
  <models>
