...
public class Text extends ElementPart {
  public static final String concept = "diglex.xml.structure.Text";
  ...
  public static Text newInstance(SModel sm, boolean init) {
    return (Text) SModelUtil_new.instantiateConceptDeclaration("diglex.xml.structure.Text", sm, GlobalScope.getInstance(), init).getAdapter();
  }
