...
public class Document extends BaseConcept implements INamedConcept {
  public static final String concept = "diglex.xml.structure.Document";
  ...
  public static Document newInstance(SModel sm, boolean init) {
    return (Document) SModelUtil_new.instantiateConceptDeclaration("diglex.xml.structure.Document", sm, GlobalScope.getInstance(), init).getAdapter();
  }
